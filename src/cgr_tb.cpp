...
void test_bundleN_directional() {
    ...
    hv_t b =        {0, 1, 3, 3, 2, 2, 3, 0, 0, 1};
    hv_t c =        {0, 1, 0, 3, 2, 2, 1, 3, 1, 1};
    hv_t d =        {3, 2, 1, 2, 3, 2, 1, 3, 2, 1};
    hv_t e =        {2, 2, 3, 2, 3, 3, 3, 1, 1, 1};
    hv_t f =        {1, 2, 3, 2, 1, 1, 1, 1, 0, 1};
    hv_t g =        {3, 2, 0, 1, 1, 0, 2, 2, 1, 1};
    hv_t h =        {2, 2, 0, 1, 2, 0, 0, 2, 1, 1};
    hv_t out_gold = {3, 2, 0, 2, 2, 2, 0, 0, 1, 1};
    hv_t out;
    hv_t hvs[] = {a, b, c, d, e, f, g, h};

    cgr_bundleN_directional(out, hvs);
    if (out != out_gold) {
        std::cout << a << std::endl;
        std::cout << b << std::endl;
        std::cout << c << std::endl;
